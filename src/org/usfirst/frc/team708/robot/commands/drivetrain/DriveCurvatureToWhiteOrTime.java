 ...
 *
 */
public class DriveCurvatureToWhiteOrTime extends Command {
    ...
    public DriveCurvatureToWhiteOrTime(double xSpeed, double zRotation, boolean isQuickTurn, double runTime) {
